 ...
 * @author abderrahim
 */
public class InformationIncompleteWeightDialog extends FDialog {
    ...
    public InformationIncompleteWeightDialog(ColorTense dialogColor, String titleHeader, Weight weight) {
    ...
    private void initLayout() {
        ...
        sequentialGroup.addComponent(this.weightDetailsPanel, 0, 0, 100);
